...
export type SysDesignLevel = 'junior' | 'mid' | 'senior' | 'staff'
...
export function nextStage(id: string): Stage | null {
...
export const LEVELS: SysDesignLevel[] = ['junior', 'mid', 'senior', 'staff']
export const LEVEL_LABEL: Record<SysDesignLevel, string> = {
  junior: 'Junior',
  mid: 'Mid',
  senior: 'Senior',
  staff: 'Staff',
