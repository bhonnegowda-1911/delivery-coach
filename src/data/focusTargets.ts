import type { DetailTendency, Session } from '../types'
...
export interface FocusTarget {
  ...
  label: string
  metric: string
  check: (session: Session) => CheckResult
}

export const ACTIVE_FOCUS_TARGETS: FocusTarget[] = [
  {
  ...
  },
  {
    ...
    check: (session) => {
      ...
      const labels: Record<DetailTendency, string> = {
