...
import { STAGES, getStage, stageIndex, nextStage, FIRST_STAGE, LEVELS } from '../data/sysdesign/stages.js'
import { PROBLEMS, getProblem, DEFAULT_PROBLEM } from '../data/sysdesign/problems.js'
import { candidateDecisions } from '../lib/sysdesign/conversation.js'
