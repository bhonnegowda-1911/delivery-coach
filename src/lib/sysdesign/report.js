...
import { STAGES, LEVELS } from '../../data/sysdesign/stages.js'
...
function buildUserMessage(stageSessions) {
  const lines = []
 ...
 * @param {Array<{stageId:string,label:string,transcript:Array,coverage:object,skipped:boolean}>} args.stageSessions
